...
# Latian Soal: Dynamic Programming Dasar (Part 1 / 6)
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(9) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 14.
- DP[1][2]: Dilema rakus. Datang dari Kiri(14) atau Atas(14)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 15.
- DP[2][1]: Dilema rakus. Datang dari Kiri(10) atau Atas(14)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 17.
- DP[2][2]: Dilema rakus. Datang dari Kiri(17) atau Atas(15)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 21.
...
- DP[1][2]: Dilema rakus. Datang dari Kiri(7) atau Atas(11)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 16.
- DP[2][1]: Dilema rakus. Datang dari Kiri(7) atau Atas(7)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 12.
- DP[2][2]: Dilema rakus. Datang dari Kiri(12) atau Atas(16)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 17.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(8) atau Atas(6)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 11.
...
- DP[2][1]: Dilema rakus. Datang dari Kiri(12) atau Atas(11)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 13.
- DP[2][2]: Dilema rakus. Datang dari Kiri(13) atau Atas(16)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 17.
...
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 10 + 1 = 11
...
- DP[2][1]: Dilema rakus. Datang dari Kiri(11) atau Atas(11)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 14.
- DP[2][2]: Dilema rakus. Datang dari Kiri(14) atau Atas(16)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 19.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(8) atau Atas(6)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 10.
- DP[1][2]: Dilema rakus. Datang dari Kiri(10) atau Atas(7)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 11.
- DP[2][1]: Dilema rakus. Datang dari Kiri(13) atau Atas(10)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 14.
- DP[2][2]: Dilema rakus. Datang dari Kiri(14) atau Atas(11)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 19.
...
- DP[0][2] (Ujung Kanan Pinggir): Ambil sisa masa lalu kiri + balok saat ini -> 10 + 4 = 14
- DP[1][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 5 + 5 = 10
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 10 + 5 = 15
- DP[1][1]: Dilema rakus. Datang dari Kiri(10) atau Atas(10)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 14.
- DP[1][2]: Dilema rakus. Datang dari Kiri(14) atau Atas(14)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 18.
- DP[2][1]: Dilema rakus. Datang dari Kiri(15) atau Atas(14)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 18.
- DP[2][2]: Dilema rakus. Datang dari Kiri(18) atau Atas(18)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 23.

Finish! Saldo akhir saat kakinya mijak kotak Pojok Kanan Bawah bernilai klimaks pada mutlak angka **23**. 
...
- DP[2][1]: Dilema rakus. Datang dari Kiri(10) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 12.
...
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 6 + 1 = 7
- DP[1][1]: Dilema rakus. Datang dari Kiri(6) atau Atas(4)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 7.
...
- DP[2][1]: Dilema rakus. Datang dari Kiri(7) atau Atas(7)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 12.
- DP[2][2]: Dilema rakus. Datang dari Kiri(12) atau Atas(12)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 16.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(7) atau Atas(4)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 12.
- DP[1][2]: Dilema rakus. Datang dari Kiri(12) atau Atas(6)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 14.
- DP[2][1]: Dilema rakus. Datang dari Kiri(9) atau Atas(12)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 14.
- DP[2][2]: Dilema rakus. Datang dari Kiri(14) atau Atas(14)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 16.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(8) atau Atas(5)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 9.
...
- DP[2][2]: Dilema rakus. Datang dari Kiri(10) atau Atas(12)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 17.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(7) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 13.
- DP[1][2]: Dilema rakus. Datang dari Kiri(13) atau Atas(10)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 14.
- DP[2][1]: Dilema rakus. Datang dari Kiri(11) atau Atas(13)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 18.
- DP[2][2]: Dilema rakus. Datang dari Kiri(18) atau Atas(14)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 22.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(3) atau Atas(6)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 10.
- DP[1][2]: Dilema rakus. Datang dari Kiri(10) atau Atas(10)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 14.
- DP[2][1]: Dilema rakus. Datang dari Kiri(7) atau Atas(10)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 14.
- DP[2][2]: Dilema rakus. Datang dari Kiri(14) atau Atas(14)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 19.
...
- DP[1][2]: Dilema rakus. Datang dari Kiri(9) atau Atas(12)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 16.
- DP[2][1]: Dilema rakus. Datang dari Kiri(9) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 14.
- DP[2][2]: Dilema rakus. Datang dari Kiri(14) atau Atas(16)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 21.
...
- DP[2][1]: Dilema rakus. Datang dari Kiri(9) atau Atas(13)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 14.
- DP[2][2]: Dilema rakus. Datang dari Kiri(14) atau Atas(16)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 19.
...
- DP[1][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 4 + 4 = 8
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 8 + 4 = 12
- DP[1][1]: Dilema rakus. Datang dari Kiri(8) atau Atas(7)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 13.
- DP[1][2]: Dilema rakus. Datang dari Kiri(13) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 17.
- DP[2][1]: Dilema rakus. Datang dari Kiri(12) atau Atas(13)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 14.
...
- DP[0][2] (Ujung Kanan Pinggir): Ambil sisa masa lalu kiri + balok saat ini -> 9 + 5 = 14
- DP[1][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 5 + 5 = 10
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 10 + 2 = 12
- DP[1][1]: Dilema rakus. Datang dari Kiri(10) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 14.
- DP[1][2]: Dilema rakus. Datang dari Kiri(14) atau Atas(14)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 17.
- DP[2][1]: Dilema rakus. Datang dari Kiri(12) atau Atas(14)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 17.
- DP[2][2]: Dilema rakus. Datang dari Kiri(17) atau Atas(17)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 20.
...
- DP[1][2]: Dilema rakus. Datang dari Kiri(8) atau Atas(10)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 12.
- DP[2][1]: Dilema rakus. Datang dari Kiri(12) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 14.
...
- DP[1][2]: Dilema rakus. Datang dari Kiri(8) atau Atas(11)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 14.
- DP[2][1]: Dilema rakus. Datang dari Kiri(5) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 12.
- DP[2][2]: Dilema rakus. Datang dari Kiri(12) atau Atas(14)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 15.
...
Tembus mutlak! Di tangga puncak 8, tercetak ada **34 kombinasi jalur mutlak**. Opsi dewa presisi adalah **C**.
</details>
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(9) atau Atas(6)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 10.
...
- DP[2][1]: Dilema rakus. Datang dari Kiri(14) atau Atas(10)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 15.
- DP[2][2]: Dilema rakus. Datang dari Kiri(15) atau Atas(11)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 18.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(5) atau Atas(7)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 12.
- DP[1][2]: Dilema rakus. Datang dari Kiri(12) atau Atas(12)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 13.
- DP[2][1]: Dilema rakus. Datang dari Kiri(7) atau Atas(12)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 13.
...
- DP[2][1]: Dilema rakus. Datang dari Kiri(12) atau Atas(12)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 17.
- DP[2][2]: Dilema rakus. Datang dari Kiri(17) atau Atas(17)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 20.
...
- DP[0][2] (Ujung Kanan Pinggir): Ambil sisa masa lalu kiri + balok saat ini -> 2 + 3 = 5
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(5) atau Atas(2)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 10.
- DP[1][2]: Dilema rakus. Datang dari Kiri(10) atau Atas(5)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 15.
...
- DP[2][2]: Dilema rakus. Datang dari Kiri(12) atau Atas(15)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 18.
...
- DP[1][2]: Dilema rakus. Datang dari Kiri(13) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 17.
- DP[2][1]: Dilema rakus. Datang dari Kiri(11) atau Atas(13)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 15.
- DP[2][2]: Dilema rakus. Datang dari Kiri(15) atau Atas(17)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 22.
