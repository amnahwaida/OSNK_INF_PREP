...
# Latian Soal: Dynamic Programming Dasar (Part 2 / 6)
...
Tembus mutlak! Di tangga puncak 7, tercetak ada **21 kombinasi jalur mutlak**. Opsi dewa presisi adalah **A**.
</details>
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(7) atau Atas(7)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 9.
...
- DP[2][1]: Dilema rakus. Datang dari Kiri(11) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 16.
- DP[2][2]: Dilema rakus. Datang dari Kiri(16) atau Atas(11)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 17.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(8) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 10.
- DP[1][2]: Dilema rakus. Datang dari Kiri(10) atau Atas(11)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 12.
...
- DP[2][2]: Dilema rakus. Datang dari Kiri(13) atau Atas(12)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 15.
...
- DP[1][2]: Dilema rakus. Datang dari Kiri(10) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 15.
- DP[2][1]: Dilema rakus. Datang dari Kiri(11) atau Atas(10)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 13.
- DP[2][2]: Dilema rakus. Datang dari Kiri(13) atau Atas(15)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 16.
...
- DP[0][2] (Ujung Kanan Pinggir): Ambil sisa masa lalu kiri + balok saat ini -> 10 + 3 = 13
- DP[1][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 5 + 4 = 9
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 9 + 2 = 11
- DP[1][1]: Dilema rakus. Datang dari Kiri(9) atau Atas(10)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 14.
- DP[1][2]: Dilema rakus. Datang dari Kiri(14) atau Atas(13)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 18.
- DP[2][1]: Dilema rakus. Datang dari Kiri(11) atau Atas(14)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 18.
- DP[2][2]: Dilema rakus. Datang dari Kiri(18) atau Atas(18)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 21.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(4) atau Atas(4)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 8.
- DP[1][2]: Dilema rakus. Datang dari Kiri(8) atau Atas(5)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 11.
...
- DP[2][2]: Dilema rakus. Datang dari Kiri(11) atau Atas(11)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 16.
...
- DP[1][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 5 + 2 = 7
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 7 + 4 = 11
- DP[1][1]: Dilema rakus. Datang dari Kiri(7) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 11.
...
- DP[2][1]: Dilema rakus. Datang dari Kiri(11) atau Atas(11)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 12.
- DP[2][2]: Dilema rakus. Datang dari Kiri(12) atau Atas(15)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 19.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(6) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 13.
- DP[1][2]: Dilema rakus. Datang dari Kiri(13) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 14.
- DP[2][1]: Dilema rakus. Datang dari Kiri(10) atau Atas(13)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 17.
- DP[2][2]: Dilema rakus. Datang dari Kiri(17) atau Atas(14)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 18.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(4) atau Atas(3)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 6.
- DP[1][2]: Dilema rakus. Datang dari Kiri(6) atau Atas(4)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 10.
- DP[2][1]: Dilema rakus. Datang dari Kiri(9) atau Atas(6)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 14.
- DP[2][2]: Dilema rakus. Datang dari Kiri(14) atau Atas(10)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 17.
...
- DP[1][2]: Dilema rakus. Datang dari Kiri(8) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 11.
- DP[2][1]: Dilema rakus. Datang dari Kiri(9) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 13.
...
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 3 + 3 = 6
- DP[1][1]: Dilema rakus. Datang dari Kiri(3) atau Atas(3)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 6.
- DP[1][2]: Dilema rakus. Datang dari Kiri(6) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 10.
- DP[2][1]: Dilema rakus. Datang dari Kiri(6) atau Atas(6)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 7.
- DP[2][2]: Dilema rakus. Datang dari Kiri(7) atau Atas(10)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 11.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(8) atau Atas(7)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 10.
- DP[1][2]: Dilema rakus. Datang dari Kiri(10) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 13.
...
- DP[2][2]: Dilema rakus. Datang dari Kiri(17) atau Atas(13)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 22.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(4) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 12.
- DP[1][2]: Dilema rakus. Datang dari Kiri(12) atau Atas(13)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 16.
- DP[2][1]: Dilema rakus. Datang dari Kiri(6) atau Atas(12)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 17.
- DP[2][2]: Dilema rakus. Datang dari Kiri(17) atau Atas(16)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 19.
...
- DP[0][0]: Kantongi 5 start.
- DP[0][1] (Ujung Kanan Pinggir): Ambil sisa masa lalu kiri + balok saat ini -> 5 + 3 = 8
- DP[0][2] (Ujung Kanan Pinggir): Ambil sisa masa lalu kiri + balok saat ini -> 8 + 4 = 12
...
- DP[1][2]: Dilema rakus. Datang dari Kiri(9) atau Atas(12)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 15.
...
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 3 + 2 = 5
- DP[1][1]: Dilema rakus. Datang dari Kiri(3) atau Atas(7)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 9.
- DP[1][2]: Dilema rakus. Datang dari Kiri(9) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 12.
- DP[2][1]: Dilema rakus. Datang dari Kiri(5) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 11.
- DP[2][2]: Dilema rakus. Datang dari Kiri(11) atau Atas(12)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 15.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(7) atau Atas(6)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 10.
- DP[1][2]: Dilema rakus. Datang dari Kiri(10) atau Atas(10)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 11.
...
- DP[2][2]: Dilema rakus. Datang dari Kiri(12) atau Atas(11)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 17.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(8) atau Atas(6)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 9.
- DP[1][2]: Dilema rakus. Datang dari Kiri(9) atau Atas(10)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 12.
- DP[2][1]: Dilema rakus. Datang dari Kiri(9) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 13.
- DP[2][2]: Dilema rakus. Datang dari Kiri(13) atau Atas(12)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 16.
...
- DP[1][2]: Dilema rakus. Datang dari Kiri(11) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 16.
- DP[2][1]: Dilema rakus. Datang dari Kiri(7) atau Atas(11)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 16.
...
- DP[0][0]: Kantongi 2 start.
- DP[0][1] (Ujung Kanan Pinggir): Ambil sisa masa lalu kiri + balok saat ini -> 2 + 1 = 3
- DP[0][2] (Ujung Kanan Pinggir): Ambil sisa masa lalu kiri + balok saat ini -> 3 + 2 = 5
- DP[1][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 2 + 5 = 7
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 7 + 3 = 10
- DP[1][1]: Dilema rakus. Datang dari Kiri(7) atau Atas(3)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 10.
- DP[1][2]: Dilema rakus. Datang dari Kiri(10) atau Atas(5)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 12.
- DP[2][1]: Dilema rakus. Datang dari Kiri(10) atau Atas(10)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 14.
- DP[2][2]: Dilema rakus. Datang dari Kiri(14) atau Atas(12)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 17.
...
- DP[1][1]: Dilema rakus. Datang dari Kiri(3) atau Atas(4)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 8.
- DP[1][2]: Dilema rakus. Datang dari Kiri(8) atau Atas(6)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 9.
- DP[2][1]: Dilema rakus. Datang dari Kiri(4) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 9.
- DP[2][2]: Dilema rakus. Datang dari Kiri(9) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 11.
...
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 7 + 4 = 11
- DP[1][1]: Dilema rakus. Datang dari Kiri(7) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 12.
...
- DP[1][2]: Dilema rakus. Datang dari Kiri(8) atau Atas(11)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 13.
- DP[2][1]: Dilema rakus. Datang dari Kiri(6) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 13.
...
- DP[2][1]: Dilema rakus. Datang dari Kiri(7) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 12.
...
Bongkar isi warisannya sel / koordinat persel:
- DP[0][0]: Kantongi 1 start.
- DP[0][1] (Ujung Kanan Pinggir): Ambil sisa masa lalu kiri + balok saat ini -> 1 + 1 = 2
- DP[0][2] (Ujung Kanan Pinggir): Ambil sisa masa lalu kiri + balok saat ini -> 2 + 4 = 6
- DP[1][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 1 + 2 = 3
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 3 + 1 = 4
- DP[1][1]: Dilema rakus. Datang dari Kiri(3) atau Atas(2)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 5.
- DP[1][2]: Dilema rakus. Datang dari Kiri(5) atau Atas(6)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 8.
- DP[2][1]: Dilema rakus. Datang dari Kiri(4) atau Atas(5)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 7.
- DP[2][2]: Dilema rakus. Datang dari Kiri(7) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 12.
...
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 9 + 5 = 14
- DP[1][1]: Dilema rakus. Datang dari Kiri(9) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 14.
- DP[1][2]: Dilema rakus. Datang dari Kiri(14) atau Atas(12)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 18.
- DP[2][1]: Dilema rakus. Datang dari Kiri(14) atau Atas(14)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 17.
- DP[2][2]: Dilema rakus. Datang dari Kiri(17) atau Atas(18)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 21.
...
- DP[1][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 5 + 2 = 7
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 7 + 3 = 10
- DP[1][1]: Dilema rakus. Datang dari Kiri(7) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 11.
- DP[1][2]: Dilema rakus. Datang dari Kiri(11) atau Atas(14)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 16.
- DP[2][1]: Dilema rakus. Datang dari Kiri(10) atau Atas(11)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 15.
- DP[2][2]: Dilema rakus. Datang dari Kiri(15) atau Atas(16)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 17.
...
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 2 + 4 = 6
- DP[1][1]: Dilema rakus. Datang dari Kiri(2) atau Atas(4)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 8.
- DP[1][2]: Dilema rakus. Datang dari Kiri(8) atau Atas(7)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(4). Maksimum Tabungan Di Area Ini = 12.
- DP[2][1]: Dilema rakus. Datang dari Kiri(6) atau Atas(8)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 10.
- DP[2][2]: Dilema rakus. Datang dari Kiri(10) atau Atas(12)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(2). Maksimum Tabungan Di Area Ini = 14.
...
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 3 + 1 = 4
- DP[1][1]: Dilema rakus. Datang dari Kiri(3) atau Atas(3)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 6.
- DP[1][2]: Dilema rakus. Datang dari Kiri(6) atau Atas(4)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(3). Maksimum Tabungan Di Area Ini = 9.
- DP[2][1]: Dilema rakus. Datang dari Kiri(4) atau Atas(6)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 7.
- DP[2][2]: Dilema rakus. Datang dari Kiri(7) atau Atas(9)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 10.

Finish! Saldo akhir saat kakinya mijak kotak Pojok Kanan Bawah bernilai klimaks pada mutlak angka **10**. 
...
- DP[1][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 1 + 2 = 3
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 3 + 3 = 6
- DP[1][1]: Dilema rakus. Datang dari Kiri(3) atau Atas(6)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 11.
...
- DP[2][1]: Dilema rakus. Datang dari Kiri(6) atau Atas(11)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 16.
- DP[2][2]: Dilema rakus. Datang dari Kiri(16) atau Atas(16)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 21.
...
- DP[1][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 2 + 2 = 4
- DP[2][0] (Jurang Bawah Kiri): Ambil sisa masa lalu Atas + balok -> 4 + 4 = 8
- DP[1][1]: Dilema rakus. Datang dari Kiri(4) atau Atas(5)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 6.
...
- DP[2][1]: Dilema rakus. Datang dari Kiri(8) atau Atas(6)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(5). Maksimum Tabungan Di Area Ini = 13.
- DP[2][2]: Dilema rakus. Datang dari Kiri(13) atau Atas(7)? Si dewa DP pilih yang maksimal!. Ambil yg gede + nilainya(1). Maksimum Tabungan Di Area Ini = 14.
