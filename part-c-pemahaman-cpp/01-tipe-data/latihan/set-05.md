...
```mermaid
graph TD
    A[Start: a=42, b=3, c=2] --> B["res1 = a/b (42/3)"]
    B --> C["Koma DIBUANG -> 14"]
    C --> D["res2 = res1/c (14/2)"]
    D --> E["Koma DIBUANG -> 7"]
```
...
```mermaid
graph TD
    A[Start: a=49, b=8, c=8] --> B["res1 = a/b (49/8)"]
    B --> C["Koma DIBUANG -> 6"]
    C --> D["res2 = res1/c (6/8)"]
    D --> E["Koma DIBUANG -> 0"]
```
...
```mermaid
graph TD
    A[Start: a=39, b=9, c=6] --> B["res1 = a/b (39/9)"]
    B --> C["Koma DIBUANG -> 4"]
    C --> D["res2 = res1/c (4/6)"]
    D --> E["Koma DIBUANG -> 0"]
```
...
```mermaid
graph TD
    A[Start: a=48, b=5, c=2] --> B["res1 = a/b (48/5)"]
    B --> C["Koma DIBUANG -> 9"]
    C --> D["res2 = res1/c (9/2)"]
    D --> E["Koma DIBUANG -> 4"]
```
...
```mermaid
graph TD
    A[Start: a=36, b=8, c=8] --> B["res1 = a/b (36/8)"]
    B --> C["Koma DIBUANG -> 4"]
    C --> D["res2 = res1/c (4/8)"]
    D --> E["Koma DIBUANG -> 0"]
```
